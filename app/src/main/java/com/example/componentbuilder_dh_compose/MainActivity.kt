...
import com.example.componentbuilder_dh_compose.ui.theme.ComponentBuilder_DH_composeTheme
...
class MainActivity : ComponentActivity() {
   ...
   lateinit var emailService1: EmailService
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            ComponentBuilder_DH_composeTheme {
               Surface(
                   ...
                   val component = appComponent.getUserConsumerComponentBuilder().retryCount(3).build()
